...
#   addkeys                             Add three subkeys (sign, encrypt, auth) to the signer key ID in ~/.local/.g/gpg_signer
...
case "$1" in
	...
	usage
        ...
        echo "  addkeys                             Add three subkeys (sign, encrypt, auth) to the signer key ID in ~/.local/.g/gpg_signer"
        ;;
    *)
